...
use function CustomPlugin\Includes\custom_widget;
...
add_action( 'widgets_init', 'CustomPlugin\Includes\custom_widget' );
...
add_action( 'widgets_init', 'CustomPlugin\Includes\widgets_init' );
